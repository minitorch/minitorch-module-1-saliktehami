...
@pytest.mark.task0_2
@given(small_floats, small_floats, small_floats, small_floats, small_floats)
def test_distribute(a: float, b: float, c: float, x: float, y: float) -> None:
...
@pytest.mark.task0_2
@given(small_floats, small_floats, small_floats)
def test_associativity(a: float, b: float, c: float) -> None:
    r"""Write a test that ensures associativity holds for multiplication, i.e.
